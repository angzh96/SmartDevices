    ...
    <el-row style="line-height:50px">
      <el-col :span="24">
        <div class="grid-content bg-purple-light">
          ...
          <el-col :span="7">
            <el-select v-model="value_id" placeholder="请选择" size="small">
              <el-option
    ...
    <el-card class="box-card" style="height:84vh">
      <el-row :gutter="20">
        <el-col :span="14" style="height:78vh">
          <baidu-map class="allmap"  :center="center" :zoom="zoom" style="width: 100%; height:75vh;" :scroll-wheel-zoom="true" @ready="handler">
